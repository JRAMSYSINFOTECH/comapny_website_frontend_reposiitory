...
export default function Footer() {
  return (
    <footer className="relative w-full text-white overflow-hidden bg-[#0B1F33]">

      {/* TOP ACCENT LINE */}
      <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#19B49A] to-transparent opacity-60" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="text-[#9EDBF0] space-y-2">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-[#9EDBF0] leading-relaxed">
          ...
          <div className="text-center sm:text-left">
            ...
            <a
              ...
              className="inline-block text-[#9EDBF0] hover:text-white mb-5 sm:mb-6 transition-colors duration-200 break-all"
            >
            ...
            <div className="flex items-center justify-center sm:justify-start gap-3 flex-wrap">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/jramsys-infotech-pvt-ltd/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer"
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/share/16bApS6nXH/" aria-label="Facebook" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 sm:w-8 sm:h-8 flex items-center justify-center rounded-full border-2 border-[#9EDBF0] text-[#9EDBF0] hover:bg-[#9EDBF0] hover:text-[#0B1F33] hover:scale-110 transition-all duration-300">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>

              {/* Instagram */}
              <a href="https://www.instagram.com/jramsys_infotech_private_ltd?igsh=ZWV3bzBicWcycjk1" aria-label="Instagram" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 sm:w-8 sm:h-8 flex items-center justify-center rounded-full border-2 border-[#9EDBF0] text-[#9EDBF0] hover:bg-[#9EDBF0] hover:text-[#0B1F33] hover:scale-110 transition-all duration-300">
